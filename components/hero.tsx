...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden bg-[#fbf8f2] text-[#241812]">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute right-[3%] top-[26%] hidden font-serif text-[25rem] leading-none tracking-[-.2em] text-[#a45f26]/[0.035] md:block">M</div>
      ...
      <div className="relative mx-auto flex min-h-screen max-w-[1500px] flex-col px-5 pb-7 pt-28 sm:px-9 lg:px-16 lg:pt-32 xl:px-24">
        ...
        <div className="flex flex-1 items-start">
          <div className="grid w-full grid-cols-1 items-start gap-10 lg:grid-cols-[.92fr_1.08fr] lg:gap-14">
            ...
            <motion.div ref={visualRef} onPointerMove={onPointerMove} onPointerLeave={resetPointer} initial={{ opacity: 0, x: 32, scale: .96 }} animate={ready ? { opacity: 1, x: 0, scale: 1 } : {}} transition={{ duration: 1, delay: .18 }} className="relative h-[340px] [perspective:1200px] sm:h-[480px] lg:h-[610px]">
