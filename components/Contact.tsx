      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        >
          <div>
            ...
            <h2 className="mt-5 max-w-3xl font-serif text-[clamp(3.2rem,6vw,6.5rem)] font-medium leading-[0.86] tracking-[-0.065em] text-[#261b15]">Your next beautiful<br /><span className="italic text-[#ad6b32]">chapter starts here.</span></h2>
          </div>
        ...
        <div className="grid overflow-hidden rounded-[1.8rem] border border-[#e1d1bf] bg-[#fffdf9] shadow-[0_28px_80px_rgba(83,53,30,.12)] lg:grid-cols-[0.83fr_1.17fr]">
          <motion.div
            ...
            className="relative min-h-[690px] overflow-hidden bg-[#24160f] p-7 text-white sm:p-10 lg:min-h-[720px] lg:p-12"
          >
